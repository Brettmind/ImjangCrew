const features = [
  {
    icon: '🗺️',
    title: '실시간 임장 지도',
    desc: '현장을 직접 방문한 멤버들이 기록한 생생한 임장 노트를 지도 위에서 한눈에 확인하세요. 사진, 동영상, 메모까지 모두 담겨 있습니다.',
  },
  {
    icon: '👥',
    title: '크루 함께 임장',
    desc: '혼자 임장은 이제 그만. 같은 지역을 관심 있는 멤버들과 함께 날짜를 잡고 함께 발로 뛰어보세요. 2배로 빠른 정보 수집이 가능합니다.',
  },
  {
    icon: '📊',
    title: '임장 체크리스트',
