    ...
    <div className="min-h-screen bg-muted/40 flex items-center justify-center px-4 py-16">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2 text-sm">무료로 가입하고 임장을 시작하세요</p>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border p-8 shadow-sm">
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-[#1877F2] hover:bg-[#166FE5] transition-colors text-sm font-medium text-white"
            >
              <FacebookIcon />
              Facebook으로 시작하기
            </button>
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            가입하면 <a href="#" className="underline">이용약관</a> 및{' '}
